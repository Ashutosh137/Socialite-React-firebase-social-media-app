...
import { check_data_is_exist, check_username_is_exist, Create_Account } from '../service/Auth/database'
        ...
        <div className='capitalize px-5'>
            ...
            <form className='flex flex-col  ' onSubmit={(e) => {
                ...
                <div className="flex-col flex my-2">
                    <label className="md:text-xl text-base font-sans p-1 mx-3 " > username</label>
